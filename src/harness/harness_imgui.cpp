...
static Logger<float> float_loggers[] = {
    ...
    { "gAccForceBefore", &gAccForceBefore, },
    { "gAccForceAfter", &gAccForceAfter,  },
    { "gAccForceAfterAfter", &gAccForceAfterAfter,  },
    { "gTorque_before", &gTorque_before, },
    { "gTorque_after", &gTorque_after,  },
    { "gTorque_after2", &gTorque_after2,  },
};
